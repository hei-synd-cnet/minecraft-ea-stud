...
public class Utility {
    ...
    /**
     * Utility method to convert a byte array in a string made up of hex (0 to 9, a to f)
     *
    ...
    /**
     * Utility method to convert a byte array in a string made up of hex (0 to 9, a to f) and
     ...
     * <p>
     * If the length of read data is zero, then no bytes are read and an empty
